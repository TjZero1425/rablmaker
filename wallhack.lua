...
if not getgenv().StarClient or getgenv().StarClient.WallHack then return end
...
local Environment = getgenv().StarClient.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().StarClient.WallHack.Functions = nil
	getgenv().StarClient.WallHack = nil
